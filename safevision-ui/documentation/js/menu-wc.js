...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">safevision-ui documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/ImagePreviewDialogComponent.html" data-type="entity-link" >ImagePreviewDialogComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/LoginComponent.html" data-type="entity-link" >LoginComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/MapDialogComponent.html" data-type="entity-link" >MapDialogComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/UserProfileDialogComponent.html" data-type="entity-link" >UserProfileDialogComponent</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="directives-links"' : 'id="xs-directives-links"' }>
                                <li class="link">
                                    <a href="directives/PhoneMaskDirective.html" data-type="entity-link" >PhoneMaskDirective</a>
                                </li>
                            </ul>
                        </li>
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/VisionService.html" data-type="entity-link" >VisionService</a>
                                </li>
                                <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/MapDialogData.html" data-type="entity-link" >MapDialogData</a>
                            </li>
                            <li class="link">
